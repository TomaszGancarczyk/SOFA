...
namespace Guide.Models.Objects
{
    public class BackpackObject
    {
        ...
        BackpackAndContainer transformer = new BackpackAndContainer(
        ...
        BackpackAndContainer errandJunior = new BackpackAndContainer(
        ...
        BackpackAndContainer sports = new BackpackAndContainer(
        ...
        BackpackAndContainer mbss = new BackpackAndContainer(
        ...
        BackpackAndContainer hellboy = new BackpackAndContainer(
        ...
        BackpackAndContainer triZip = new BackpackAndContainer(
